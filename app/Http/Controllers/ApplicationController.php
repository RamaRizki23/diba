...
class ApplicationController extends Controller
{
    ...
    private function validated(Request $request): array
    {
        return $request->validate([
            ...
            'architecture' => ['nullable', 'string', 'max:150'],
            'server_location' => ['nullable', 'string', 'max:150'],
            'pic' => ['nullable', 'string', 'max:150'],
            'pic_phone' => ['nullable', 'string', 'max:50'],
            'geoaccess' => ['nullable', 'string', 'max:80'],
            'login_type' => ['nullable', 'string', 'max:80'],
            'splp_connection' => ['nullable', 'string', 'max:80'],
            'profile_status' => ['nullable', 'string', 'max:80'],
            'repository_status' => ['nullable', 'string', 'max:80'],
            'pse_status' => ['nullable', 'string', 'max:80'],
            'pse_badge' => ['nullable', 'string', 'max:150'],
            'api_availability' => ['nullable', 'string', 'max:80'],
            'haki_status' => ['nullable', 'string', 'max:80'],
            'haki_year' => ['nullable', 'integer', 'between:1900,2100'],
            'total_investment' => ['nullable', 'numeric', 'min:0'],
            'development_expansion_cost' => ['nullable', 'numeric', 'min:0'],
            'application_type' => ['nullable', 'string', 'max:100'],
            'license' => ['nullable', 'string', 'max:100'],
            'platform_basis' => ['nullable', 'string', 'max:100'],
            'e_service_type' => ['nullable', 'string', 'max:100'],
            'user_type' => ['nullable', 'string', 'max:100'],
            'developer_type' => ['nullable', 'string', 'max:100'],
            'developer_name' => ['nullable', 'string', 'max:150'],
            'personal_data' => ['nullable', 'string', 'max:80'],
            'support_info' => ['nullable', 'string', 'max:150'],
            'business_process' => ['nullable', 'string'],
