...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        .main:before { content:''; display:block; height:56px; margin:0 -28px 26px; background:#fff; border-bottom:1px solid var(--line); }
        ...
        .panel { background:#fff; border:1px solid var(--line); border-radius:3px; padding:18px; }
